...
public class BaseElementView extends View implements BaseElement{
	...
	public BaseElementView(MapView mapView, Point point) {
...
//		layout((int) (values[2] - getDeltaWdith() + point.getX()* values[0]), 
//				(int) (values[5] - getDeltaHeight() + point.getY() * values[4]), 
//				(int) (getBeWidth() + values[2] - getDeltaWdith() + point.getX() * values[0]),
//				(int) (getBeHeight() + values[5] - getDeltaHeight() + point.getY() * values[4]));
	}
